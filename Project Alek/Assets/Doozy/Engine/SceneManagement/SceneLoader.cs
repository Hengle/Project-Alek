...
//            Debug.Log("CurrentAsyncOperation == null? " + (CurrentAsyncOperation == null));
        ...
        public Progressor LoadSceneAsync(int sceneBuildIndex, LoadSceneMode mode)
        {
            ...
            CurrentAsyncOperation = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(sceneBuildIndex, mode);
            StartSceneLoad();
            return Progressor;
        }
        ...
        public Progressor LoadSceneAsync(string sceneName, LoadSceneMode mode)
        {
            ResetProgress();
            LoadBehavior.OnLoadScene.Invoke(gameObject);
            CurrentAsyncOperation = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(sceneName, mode);
            StartSceneLoad();
            return Progressor;
        }
