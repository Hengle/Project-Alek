...
namespace Doozy.Engine.UI.Nodes
{
    ...
    public class UnloadSceneNode : Node
    {
        ...
        private void SceneUnloaded(Scene unloadedScene)
        {
            ...
            switch (GetSceneBy)
            {
                case GetSceneBy.Name:
                    ...
                    break;
                case GetSceneBy.BuildIndex:
                    if (!unloadedScene.name.Equals(UnityEngine.SceneManagement.SceneManager.GetSceneByBuildIndex(SceneBuildIndex).name))
                        return;
                    break;
            }
        ...
        public override void CheckForErrors()
        {
            ...
            ErrorBadBuildIndex = GetSceneBy == GetSceneBy.BuildIndex && (SceneBuildIndex < 0 || SceneBuildIndex + 1 > UnityEngine.SceneManagement.SceneManager.sceneCountInBuildSettings);
#endif
        }
    }
}