...
namespace BrainFailProductions.PolyFew
{
    ...
    public class MaterialCombiner : MonoBehaviour
    {
        ...
        private static Dictionary<GameObject, List<CombiningInformation.MaterialEntity>> InitializeFromGameObjects(List<GameObject> gameObjectsList, CombiningInformation.TextureArrayGroup textureArraysSettings, CombiningInformation.DiffuseColorSpace diffuseColorSpace, bool regardChildren, Action<string> OnError)
        {
            ...
            var objectsMaterialLinks = new Dictionary<GameObject, List<CombiningInformation.MaterialEntity>>();
            ...
            foreach (GameObject gameObject in gameObjectsList)
            {
                ...
                foreach (Renderer renderer in renderers)
                {
                    ...
                    foreach (Material material in materials)
                    {
                        ...
                        CombiningInformation.MaterialEntity materialEntity = null;
                        ...
                        {
                            materialEntity = new CombiningInformation.MaterialEntity();
                        ...
                        {
                            materialEntity.combinedMats = new List<CombiningInformation.CombineMetaData>();
                        }

                        Mesh sharedMesh = meshFilter != null ? meshFilter.sharedMesh : skinnedMeshRenderer.sharedMesh;

                        var materialProperties = new CombiningInformation.MaterialProperties();
                        ...
                        {
                            var entititesLinked = new List<CombiningInformation.MaterialEntity>();
                            entititesLinked.Add(materialEntity);
        ...
        public static bool CombineMaterials(GameObject[] gameObjectsList, string savePath, CombiningInformation.TextureArrayGroup textureArraysSettings, CombiningInformation.DiffuseColorSpace diffuseColorSpace, bool regardChildren, bool displayErrorBox, Action<string> OnError)
        {
            ...
            try
            {
                ...
                List<CombiningInformation.MaterialEntity> srcMatEntitites = objectsData.materialEntities;
...
#pragma warning disable
                ...
                for (int a = 0; a < srcMatEntitites.Count; ++a)
                {
                    try
                    {
                        ...
                        CombiningInformation.MaterialEntity arrayToGenerate = srcMatEntitites[a];
...
#pragma warning disable
                                ...
                                for (int c = 0; c < sourceMesh.subMeshCount; ++c)
                                {
                                    ...
                                    foreach (var link in objectsMaterialLinks)
                                    {
                                        List<CombiningInformation.MaterialEntity> materialEntitiesLinked = link.Value;
                ...
                foreach (var link in objectsMaterialLinks)
                {
                    ...
                    foreach (var matEntity in materialEntitiesLinked)
                    {
                        ...
                        {
                            CombiningInformation.MaterialProperties props = combMat.materialProperties;
        ...
        private static CombiningInformation.MaterialEntity GetMaterialEntityWithDiffuseMap(CombiningInformation combineInfo, Texture2D diffuseMap)
        {
            foreach (CombiningInformation.MaterialEntity materialEntity in combineInfo.materialEntities)
            {
        ...
        private static void AddCombine(Mesh sharedMesh, CombiningInformation.MaterialProperties materialProperties, CombiningInformation.MaterialEntity materialEntity, CombiningInformation combineInfo, MeshFilter meshFilter, MeshRenderer meshRenderer, SkinnedMeshRenderer skinnedMeshRenderer)
        {
            var comb = FindCombine(materialProperties.originalMaterial, materialEntity);

            if (comb == null)
            {
                comb = new CombiningInformation.CombineMetaData
                {
                    material = materialProperties.originalMaterial,
                    materialProperties = materialProperties,
                    meshesData = new List<CombiningInformation.MeshData>()
                };
        ...
        private static CombiningInformation.CombineMetaData FindCombine(Material material, CombiningInformation.MaterialEntity textureArray)
        {
            foreach (var comb in textureArray.combinedMats)
            {
        ...
        public static Texture2DArray AllocateArray(CombiningInformation.TextureArrayUserSettings arraySettings, int texturesCount, CombiningInformation.DiffuseColorSpace diffuseColorSpace, bool hasAlphaChannel)
        {
        ...
        public static void CompressTexture(Texture2D toCompress, CombiningInformation.TextureArrayUserSettings arraySettings, bool hasAlphaChannel)
        {
        ...
        public static int SizeToMipCount(CombiningInformation.TextureArrayUserSettings arrayProperties)
        {
        ...
        {
            int a = 0;
            CombiningInformation.MaterialProperties materialProperties = new CombiningInformation.MaterialProperties();
